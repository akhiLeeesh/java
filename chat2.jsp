...
Connection ccc=databasecon.getconnection();
	...
	String sss = "select * from msgs  where chatof='"+email+""+femail+"'  order by sno ";

	ResultSet r=ss.executeQuery(sss);
	while(r.next())
	{
		if(r.getString("user_").equals(email)){
%>
<div class="container">
  <img src="images/mentee.png" alt="Avatar" width="30" height="50">
...
<div class="container darker">
  <img src="images/mentor.png" alt="Avatar" width="30" height="50" class="right">
...
%>
					...
					<form method="post" action="chat3.jsp">
						...
						<input type="hidden" name="mentor" value="<%=femail%>">
</form>
<!-- </table> -->
</body>
</html>
